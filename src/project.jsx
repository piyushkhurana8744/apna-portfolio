       ...
       <Box className={styles.mid_sec}>
        <Box className={styles.child}>
          <img style={{height:"50%",width:"100%",borderTopRightRadius:"10px",borderTopLeftRadius:"10px"}} src="https://cdn.dribbble.com/users/4400366/screenshots/15917760/media/21dd5982b34f1e95353b3a8089862f83.png?compress=1&resize=400x300" alt="expedia" />
           <h2 className={styles.proName}>Expedia</h2>
           ...
           <p style={{fontSize:"12px",marginTop:"5px"}}><span style={{color:"blue",fontSize:"17px",fontWeight:"bold"}}>Tech Stack:-</span>HTML,CSS and JavaScript</p>
        ...
        <h2 className={styles.proName}>Nike</h2>
           ...
           <p style={{fontSize:"12px",marginTop:"5px"}}><span style={{color:"blue",fontSize:"17px",fontWeight:"bold"}}>Tech Stack:-</span>React Js Chakra UI </p>
...
<h2 className={styles.proName}>YouTube</h2>
...
<h2 className={styles.proName}>Toggle Track</h2>
